    ...
    def plot_training_history(self, training_history):
        ...
        for row in range(rows):
            for col in range(cols):
                ...
                figure = training_history[index]["label"]
                loss = training_history[index]["loss"]
                val_loss = training_history[index]["val_loss"]

                axes[row][col].set_title(figure)
                axes[row][col].plot(loss)
                axes[row][col].plot(val_loss)
                axes[row][col].legend(['train', 'val'])
                # axes[row][col].set_xlabel("epock")
